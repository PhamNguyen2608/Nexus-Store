        ...
        >
          <div className={styles.notFoundContent}>
            ...
            <div className={styles.notFoundText}>
              <h2>
                <span>{location.pathname.substring(22)}</span> Không khả dụng!
              </h2>
              <p>
                Trang bạn cố gắng truy cập không khả dụng. Bạn sẽ được chuyển
                hướng đến mục duyệt của chúng tôi trong chốc lát. Nếu bạn cho
                rằng đây là lỗi,{" "}
                <span className={styles.contact}>Liên hệ chúng tôi!</span>
              </p>
            </div>
          </div>
          <motion.div
